...
public class TotemChangerAnimationScreen extends Screen {
    ...
    @Override
    protected void init() {
        addRenderableWidget(new Button(5, 5, 120, 20, Component.translatable("totemchanger.particles"), button -> minecraft.setScreen(new TotemChangerParticlesScreen(parent))));
