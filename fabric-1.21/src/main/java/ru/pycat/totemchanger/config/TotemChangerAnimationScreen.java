...
public class TotemChangerAnimationScreen extends Screen {
    ...
    protected void init() {
        ...
        addRenderableWidget(enabled = Checkbox.builder(Component.translatable("totemchanger.animation.option.enabled"), Minecraft.getInstance().font)
                .pos(width / 2 - font.width(Component.translatable("totemchanger.animation.option.enabled")), 40)
                .selected(TotemChangerAnimationConfig.enabled)
                .build());
